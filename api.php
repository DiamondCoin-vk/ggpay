...
define("DB_HOST", "82.146.63.70"); //Сервер базы данных
define("DB_USERNAME", "phpmyadmin"); //Пользователь базы данных
define("DB_PASSWORD", "zalupka1335"); //Пароль от пользователя базы данных
define("DB_NAME", "ggpay"); //Имя базы данных
define("APP_SECRET", "QD5OT2lryShtUhCwsW1b"); //Защищенный ключ приложения
define("SERVICE_KEY", "f387d2ddf387d2ddf387d2ddd6f3f22fb9ff387f387d2dd9613491942108ce30d692924");
